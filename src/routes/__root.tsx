...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:image", content: "https://pub-bb2e103a32db4e198524a2e9ed8f35b4.r2.dev/9ffeb116-a116-479e-b6da-40d321e2add3/id-preview-be960da6--dbfb05cf-3981-4ab4-afb3-5541f3f66aba.lovable.app-1784209903911.png" },
      { name: "twitter:image", content: "https://pub-bb2e103a32db4e198524a2e9ed8f35b4.r2.dev/9ffeb116-a116-479e-b6da-40d321e2add3/id-preview-be960da6--dbfb05cf-3981-4ab4-afb3-5541f3f66aba.lovable.app-1784209903911.png" },
    ],
    links: [
...
function RootComponent() {
  ...
  useEffect(() => {
    // Prevent browsers from restoring scroll into Page 002 on refresh, which
    // would make the scroll-scrubbed hand animation appear to autoplay.
