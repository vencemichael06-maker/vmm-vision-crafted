  ...
  return (
    <div className="relative bg-vmm-canvas text-vmm-ink">
      ...
      <section ref={heroRef} className="relative min-h-[100svh] w-full overflow-hidden pt-28 md:pt-32">
        ...
        {/* Full-width red panel */}
        <div
          aria-hidden
          className="vmm-hero-red-panel absolute right-0 top-[52%] hidden h-[42%] w-[58%] bg-vmm-red md:block"
        />
        {/* Mobile red band under text */}
        <div
          aria-hidden
          className="vmm-hero-red-panel absolute inset-x-0 top-[54%] block h-[46%] bg-vmm-red md:hidden"
        />

        <div className="relative mx-auto grid w-full max-w-[1760px] grid-cols-1 gap-8 px-5 pb-24 md:grid-cols-12 md:px-16 md:pb-32 lg:px-24">
          ...
          <div className="relative md:col-span-6">
            <div className="relative mx-auto aspect-[3/4] w-full max-w-[560px] md:absolute md:right-0 md:top-0 md:h-[110%] md:w-[62vw] md:max-w-none">
              ...
              <img
                ...
                alt=""
                aria-hidden
                className="vmm-hero-red-overlay absolute inset-x-0 bottom-0 h-full w-full select-none object-contain object-bottom mix-blend-normal"
              />
            </div>
          </div>
        </div>
