      ...
      <div className="sticky top-0 min-h-[100svh] w-full overflow-hidden bg-white">
        ...
        <div className="vmm-container relative z-[2] grid min-h-[100svh] grid-cols-12 items-center pb-20 pt-24 md:pb-24 md:pt-28">
          <div
            ...
            className="col-span-7 z-[3] self-center pr-2 md:col-span-5 lg:col-span-4 lg:col-start-2"
          >
            <p className="vmm-kicker">ABOUT ME</p>
            <h2 className="vmm-about-title mt-4 font-display uppercase">
              <span className="block whitespace-nowrap">
                I DESIGN<span className="text-vmm-red">.</span>
              </span>
              <span className="block whitespace-nowrap">
                I BUILD<span className="text-vmm-red">.</span>
              </span>
              <span className="block whitespace-nowrap">
                I SOLVE<span className="text-vmm-red">.</span>
              </span>
            </h2>
          ...
          <div
            ...
            className="pointer-events-none absolute bottom-0 right-[-10%] z-[1] h-[91%] w-[66%] sm:right-[-4%] sm:w-[61%] md:right-[3%] md:h-[92%] md:w-[58.333%] lg:right-[11%] lg:h-[96%] lg:w-[48%]"
          >
            <HandRevealFrameSequence progress={progress} reducedMotion={reducedMotion} />
          </div>

          <div className="vmm-about-marker absolute left-5 z-[4] flex items-end gap-3 md:hidden">
            <span
